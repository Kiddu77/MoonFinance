    ...
    <div className="min-h-screen bg-white text-black">
        <div className='h-[20%] bg-[#F9F8F8] flex justify-center space-x-52'>
          <div className='h-1/2 flex items-center mt-10 p-4 bg-'>
            {/* Rupee div */}
            <div className='text-2xl flex-row text-[#6A706E]'>Invested Amount
        ...
        <div className='h-full mt-6'>
          {/* about the alloc */}
          <div className='text-3xl pt-10 px-20 font-semibold '>About the Allocation
            <div className='flex flex-row'>
            <div className='w-1/2 h-full font-thin text-[#6A706E] p-4 text-lg'>
              {/* Text and Button  */}
              <p className='pb-8'>Lorem ipsum dolor sit amet consectetur. Nec mauris ut id quam netus. Pellentesque sed aliquet tortor auctor dictum sodales leo. Sed donec ut laoreet rhoncus pulvinar. Mauris et ac nisi in ipsum sed etiam.
              Pellentesque sed aliquet tortor auctor dictum sodales leo.Sed donec ut laoreet rhoncus pulvinar.etiam.
              Pellentesque sed aliquet tortor aucto</p>
              
              <button className='rounded-lg w-[52%] h-fit bg-[#12C38C] p-4 text-white font-extrabold'>Take Quiz Again</button>
              <p className='text-sm text-center w-[52%]'>You can risk analyse before investing.</p>
              <div className='flex items-center pt-2'>
              <FaSquarePhone className='text-[#12C38C] text-5xl mt-4'>
              </FaSquarePhone>

              <p className='font-bold text-black px-4 text-3xl pt-4'>Contact Us</p>
              </div>
            </div>
