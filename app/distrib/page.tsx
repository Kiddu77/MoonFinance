...
const DistribPage: React.FC = () => {
  ...
  const [investment, setInvestment] = useState(0); // Store the dynamic investment amount
  ...
  useEffect(() => {
    ...
    if (answers) {
      try {
        ...
        // Extract the investment amount (ensure it's a number)
        ...
        // Initialize asset allocation values
        let equity = 0;
        let debt = 0;
        let gold = 0;

        // Asset allocation based on scores
        if (risk_score <= 0.5 && stability_score >= 1.5) {
          // Very low risk, high stability
          equity = 20;
          debt = 60;
          gold = 20;
        } else if (risk_score <= 1 && stability_score >= 1) {
          // Low risk, moderate stability
          equity = 30;
          debt = 50;
          gold = 20;
        ...
        if (diversity_score >= 1.5) {
          ...
          // Low diversity, concentrate more on equity
          equity += 10;
          debt -= 5;
          gold -= 5;
        }
          ...
          <div className="flex flex-col-reverse md:flex-row items-center ">
            <div className="w-full md:w-1/2 h-full font-thin text-[#6A706E] p-4 text-lg">
              ...
              <div className="flex items-center pt-2 md:justify-normal justify-center">
                ...
                <div>
                  <a className="font-bold text-black px-4 text-3xl pt-4"
